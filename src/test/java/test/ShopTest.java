...
public class ShopTest {
    ...
    void shouldShowWarningIfCardIsExpiredForPayment() {
        ...
        assertTrue(paymentPage.inputInvalidIsVisible(),"Should show warning if card expired, payment page");
    }
    ...
    void shouldShowWarningIfCardIsExpiredForCredit() {
        ...
        assertTrue(creditPage.inputInvalidIsVisible(),"Should show warning if card expired, credit page");
    }
    ...
    void shouldShowWarningIfExpirationDateMoreThan5YearsForPayment() {
        ...
        assertTrue(paymentPage.inputInvalidIsVisible(),"Should show warning if expiration date more than 5 years, payment page");
    }
    ...
    void shouldShowWarningIfExpirationDateMoreThan5YearsForCredit() {
        ...
        assertTrue(creditPage.inputInvalidIsVisible(),"Should show warning if expiration date more than 5 years, credit page");
    }
}